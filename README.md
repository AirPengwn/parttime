...
- `jobs-data.json` — the underlying dataset (232 listings), regenerated from the embedded array so the two stay in parity.
...
- **232 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

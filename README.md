...
- `jobs-data.json` — the underlying dataset (118 listings), regenerated from the embedded array so the two stay in parity.
...
- **118 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

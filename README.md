...
- `jobs-data.json` — the underlying dataset (106 listings), regenerated from the embedded array so the two stay in parity.
...
- **106 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

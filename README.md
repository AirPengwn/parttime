...
- `jobs-data.json` — the underlying dataset (341 listings), regenerated from the embedded array so the two stay in parity.
...
- **341 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

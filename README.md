...
- `jobs-data.json` — the underlying dataset (225 listings), regenerated from the embedded array so the two stay in parity.
...
- **225 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

...
- `jobs-data.json` — the underlying dataset (263 listings), regenerated from the embedded array so the two stay in parity.
...
- **263 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

...
- `jobs-data.json` — the underlying dataset (269 listings), regenerated from the embedded array so the two stay in parity.
...
- **269 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

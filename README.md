...
- `jobs-data.json` — the underlying dataset (365 listings), regenerated from the embedded array so the two stay in parity.
...
- **365 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

...
- `jobs-data.json` — the underlying dataset (165 listings), regenerated from the embedded array so the two stay in parity.
...
- **165 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

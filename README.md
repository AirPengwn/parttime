...
- `jobs-data.json` — the underlying dataset (323 listings), regenerated from the embedded array so the two stay in parity.
...
- **323 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

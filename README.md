...
- `jobs-data.json` — the underlying dataset (133 listings), regenerated from the embedded array so the two stay in parity.
...
- **133 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

...
- `jobs-data.json` — the underlying dataset (208 listings), regenerated from the embedded array so the two stay in parity.
...
- **208 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

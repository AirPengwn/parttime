...
- `jobs-data.json` — the underlying dataset (237 listings), regenerated from the embedded array so the two stay in parity.
...
- **237 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

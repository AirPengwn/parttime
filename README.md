...
- `jobs-data.json` — the underlying dataset (128 listings), regenerated from the embedded array so the two stay in parity.
...
- **128 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,

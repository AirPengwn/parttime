...
- `jobs-data.json` — the underlying dataset (229 listings), regenerated from the embedded array so the two stay in parity.
...
- **229 job cards** with rich metadata: category, employer, town **+ distance**, pay, type,
